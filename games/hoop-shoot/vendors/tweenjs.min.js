...
((this.createjs = this.createjs || {}),
  ...
  (function () {
    ...
    ((Ticker.init = function () {
      ...
      (Ticker.getMeasuredFPS = function (a) {
        ...
        return !b || b.length < 2
          ? -1
          : ((a = Math.min(b.length - 1, a || 0 | Ticker._getFPS())),
            1e3 / ((b[0] - b[a]) / a));
      }),
    ...
    ((Ticker._getTime = function () {
      return (
        ((c && c.call(b.performance)) || new Date().getTime()) -
        Ticker._startTime
      );
    }),
  ...
  (function () {
    ...
    ((a._setPaused = function (a) {
      ...
      (a.setPaused = createjs.deprecate(
        a._setPaused,
      ...
      (a.getPaused = createjs.deprecate(
        a._getPaused,
      ...
      (a.getCurrentLabel = createjs.deprecate(
        a._getCurrentLabel,
    ...
    ((a.advance = function (a, b) {
      ...
      (createjs.AbstractTween = createjs.promote(
        AbstractTween,
        "EventDispatcher",
      )));
  })(),
  ...
  (function () {
    ...
    function Tween(b, c) {
      (this.AbstractTween_constructor(c),
        ...
        (this._injected = null),
        c &&
          ((this.pluginData = c.pluginData),
          c.override && Tween.removeTweens(b)),
    ...
    ((Tween.IGNORE = {}),
      ...
      (Tween.tick = function (a, b) {
        for (var c = Tween._tweenHead; c; ) {
          var d = c._next;
          ((b && !c.ignoreGlobalPause) ||
            c._paused ||
            c.advance(c.useTicks ? 1 : a),
            (c = d));
        }
      }),
      ...
      (Tween._installPlugin = function (a) {
        for (
          var b = (a.priority = a.priority || 0),
            c = (Tween._plugins = Tween._plugins || []),
            d = 0,
            e = c.length;
          e > d && !(b < c[d].priority);
          d++
      ...
      (Tween._register = function (a, b) {
        ...
        if (!b && a._paused) {
          ...
          (d
            ? ((Tween._tweenTail = d._next = a), (a._prev = d))
            : (Tween._tweenHead = Tween._tweenTail = a),
            !Tween._inited &&
              createjs.Ticker &&
      ...
      (c.wait = function (a, b) {
        return (
          a > 0 && this._addStep(+a, this._stepTail.props, null, b),
          this
        );
      }),
      (c.to = function (a, b, c) {
      ...
      (c._appendProps = function (a, b, c) {
        ...
        for (d in a)
          if (a.hasOwnProperty(d) && ((o[d] = n[d] = a[d]), void 0 === i[d])) {
            ...
            g !== Tween.IGNORE &&
              (void 0 === g && (g = j[d]), (m[d] = void 0 === g ? null : g));
          }
        for (d in o) {
          f = a[d];
        ...
        (h = this._injected) &&
          ((this._injected = null), this._appendProps(h, b, !1));
      }),
  ...
  (function () {
    ...
    ((a.addTween = function (a) {
      ...
      (a._updatePosition = function (a) {
        for (var b = this.position, c = 0, d = this.tweens.length; d > c; c++)
          this.tweens[c].setPosition(b, !0, a);
      }),
    ...
    ((a.priority = 0),
      ...
      (a.step = function (b, c, d) {
        for (var e in d)
          if ("guide" === e) {
            ...
            var h = f.endData;
            if (
              (b._injectProp("x", h.x), b._injectProp("y", h.y), g || !f.orient)
            )
              break;
            var i =
            ...
            if (
              ...
              var j =
                  void 0 === d.rotation ? b.target.rotation || 0 : d.rotation,
      ...
      (a._ratioToPositionData = function (b, c, d) {
        ...
        return (
          ...
          c.orient &&
            (b >= 0.99999 && 1.00001 >= b && void 0 !== c.endAbsRot
