...
(function () {
  ...
  Box2D.postDefs.push(function () {
    ...
    Box2D.Common.Math.b2Math.b2Mat22_identity = F.FromVV(
      new A(1, 0),
      new A(0, 1),
    );
    Box2D.Common.Math.b2Math.b2Transform_identity = new w(
      K.b2Vec2_zero,
      K.b2Mat22_identity,
    );
  });
...
(function () {
  ...
  k.prototype.ResetMassData = function () {
    ...
    if (
      !(this.m_type == k.b2_staticBody || this.m_type == k.b2_kinematicBody)
    ) {
  ...
  Z.prototype.SolveTOI = function (a) {
    ...
    for (c = 0; c < a.positionIterations; ++c) {
      ...
      f = true;
      for (g = 0; g < this.m_jointCount; ++g) {
        var m = this.m_joints[g].SolvePositionConstraints(
          A.b2_contactBaumgarte,
        );
        f = f && m;
      }
      if (e && f) break;
  ...
  k.prototype.SolvePositionConstraints = function () {
    ...
    if (this.m_enableLimit) {
      ...
      if (
        ...
        m = y.Clamp(
          v - this.m_lowerTranslation + F.b2_linearSlop,
          -F.b2_maxLinearCorrection,
          0,
        );
        ...
        m = y.Clamp(
          v - this.m_upperTranslation + F.b2_linearSlop,
          0,
          F.b2_maxLinearCorrection,
        );
