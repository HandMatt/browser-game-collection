(function (lib, img, cjs) {
  ...
  (lib.SlowBall = function () {
    ...
    this.shape.graphics
      ...
      .ss(1, 1, 1)
      .p(
        "Ag8BzQgQgJgOgOQgngmAAg2QAAg0AngmQAOgOAQgJQAcgQAgAAQAhAAAcAPQAQAJAPAPQAmAmAAA0QAAA2gmAmQgPAOgRAJQgbAPghAAQggAAgcgPgAA9hyIgBDlAg8hxIAADk",
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AA9hyQAQAJAPAPQAmAmgBA0QABA1gmAnQgPAOgRAJgAhaBcQgngnABg1QgBg0AngmQAOgOAQgJIAADjQgQgIgOgOg",
      );
    ...
    this.shape_2.graphics
      .f("#FF9900")
      .s()
      .p("Ag8BzIAAjkQAcgPAgAAQAhAAAcAOIgBDlQgbAPghgBQggAAgcgOg");
  ...
  (lib.ScoreBoard = function () {
    ...
    this.shape.graphics
      ...
      .s("#000000")
      .p(
        "AESCJQAAAGgCAFQgCAFgEAAIhkgBQgmgBgdACIghABQhAABiEABQgWgDgMAAIhkAAQgDAAgDgFQgDgEAAgHIAAhBQgChJAChKIAAhCQAAgGADgEQADgEADAAIISAAQAEAAACAEQACAEAAAGIAABCQgBAZABAxQACAugCAbg",
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AikCZIhkAAQgDAAgDgFQgDgEAAgHIAAhBQgChJAChKIAAhCQAAgGADgEQADgEADAAIISAAQAEAAACAEQACAEAAAGIAABCQgBAZABAxQACAugCAbIAABBQAAAGgCAFQgCAFgEAAIhkgBQgmgBgdACIghABIjEACQgWgDgMAAg",
      );
  ...
  (lib.PlayButton = function () {
    ...
    this.shape.graphics
      ...
      .s("#000000")
      .p(
        "ANCDbQAAAKgGAGQgHAHgKAAQhAAAjxgCQiHgBhvADQjZAFkQgBQlHgDjCgBIg8AAQgJAAgIgHQgGgGAAgKIAAhlQAEhOgBhAQgDiJAAg0QAAgKAGgGQAHgHAKAAIBrAAQC/gNFpAFQFwAGBbgGQDZABB+ADQCAAEAgAAQAKAAAHAHQAGAHAAAJIAABlQgEBOABBAQADCKAAAzg",
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AjlD2IoJgEIg8AAQgJAAgIgHQgGgGAAgKIAAhlQAEhOgBhAQgDiJAAg0QAAgKAGgGQAHgHAKAAIBrAAQC/gNFpAFQFwAGBbgGQDZABB+ADICgAEQAKAAAHAHQAGAHAAAJIAABlQgEBOABBAQADCKAAAzQAAAKgGAGQgHAHgKAAIkxgCQiHgBhvADQi4AEjeAAIhTAAg",
      );
  ...
  (lib.Levels = function (mode, startPosition, loop) {
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        ...
        .to({ state: [{ t: this.shape_1 }, { t: this.instance_1 }] }, 1)
        .to({ state: [{ t: this.shape_2 }, { t: this.instance_2 }] }, 1)
        .to({ state: [{ t: this.shape_3 }, { t: this.instance_3 }] }, 1)
        .to({ state: [{ t: this.shape_4 }, { t: this.instance_4 }] }, 1)
        .to({ state: [{ t: this.shape_5 }, { t: this.instance_5 }] }, 1)
        .wait(1),
    );
  ...
  (lib.HoopSensor = function () {
    ...
    this.shape = new cjs.Shape();
    this.shape.graphics
      .f("rgba(102,255,0,0.62)")
      .s()
      .p("AjGAdIAAg5IGNAAIAAA5g");
  ...
  (lib.BouncyBall = function () {
    ...
    this.shape.graphics
      ...
      .ss(1, 1, 1)
      .p(
        "AguhXQAVgMAZAAQAaAAAVAMQANAHALALQAdAdAAAoQAAApgdAeQgLALgNAHQgVALgaAAQgZAAgVgMQgMgGgLgLQgegeAAgpQAAgoAegdQALgLAMgHIAACvAAvhXIAACw",
      );
    ...
    this.shape_1.graphics
      .f("#FFFF00")
      .s()
      .p("AguBYIAAivQAVgMAZABQAaAAAVALIAACwQgVALgagBQgZAAgVgLg");
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "AAuhXQAOAHALALQAdAdgBAoQABApgdAeQgLALgOAGgAhFBHQgegeABgpQgBgoAegdQALgLAMgHIAACvQgMgHgLgKg",
      );
  ...
  (lib.PowerArrow = function () {
    ...
    this.shape = new cjs.Shape();
    this.shape.graphics
      .f("rgba(102,255,0,0.4)")
      .s()
      .p("ACoCJIpMAAIAAkRIJMAAIAAiaID9EiIj9EjgAk+AzIHjAAIAAhfInjAAg");
  ...
  (lib.LevelSelection = function () {
    ...
    this.shape.graphics
      ...
      .ss(1, 1, 1)
      .p(
        "AewOuIAAFcMggBAAAQh3AIiWgCQhBgBjJgHQjDgHh6ADIjxAEQh1ACh2AAIoxAAIAAnKQgMikAEj6QAIkUAAiJIAA0NILMAAQCmgMEQAIQFVAJBcgCQAZAAA0ACQCZgCEzgGQEPgDC+AIQAZAAAxgCICWAAQCFgDDDABQBtABDZABIHbAAIAAUMQAKE+ABCXQACECgNDTg",
      );
    ...
    this.shape_3.graphics
      .f("#FFFFFF")
      .s()
      .p("AwCADQhAAAjKgFMAoZAAAIAAABMggBAAAQhfAEh0AAIg7AAg");
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "A9OBQIhjieIIxAAQB1AAB1gBIIuAAQDJAHBBAAQCWACB3gIMAgBAAAIAAgBIADAAIhnCfg",
      );
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "ApoUMQjDgHh6ADIjxAEIscAAIAAnIQgMikAEj6QAIkUAAiJIAA0NILMAAQCmgMEQAIQFVAJBcgCIBNACIHMgIQEPgDC+AIQAZAAAxgCICWAAQCFgDDDABIFGACIHbAAIAAUMQAKE+ABCXQACECgNDTIAAFag",
      );
