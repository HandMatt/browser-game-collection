...
((this.createjs = this.createjs || {}),
  ...
  (function () {
    ...
    ((BrowserDetect.isWindowPhone =
      a.indexOf("IEMobile") > -1 || a.indexOf("Windows Phone") > -1),
      ...
      (BrowserDetect.isAndroid =
        a.indexOf("Android") > -1 && !BrowserDetect.isWindowPhone),
    ...
    ((b.LOAD_TIMEOUT_DEFAULT = 8e3),
      (b.create = function (a) {
        ...
        if (a instanceof Object && a.src)
          return (
            null == a.loadTimeout && (a.loadTimeout = b.LOAD_TIMEOUT_DEFAULT),
            a
          );
  ...
  (function () {
    ...
    ((b.create = function (a) {
      ...
      if (null == a || a instanceof b || a instanceof Object)
  ...
  (function () {
    ...
    ((b.INTERRUPT_ANY = "any"),
      ...
      (b.getCapabilities = createjs.deprecate(
        b._getCapabilities,
      ...
      (b._handleLoadError = function (a) {
        ...
        if (b._preloadHash[c])
          for (var d = 0, e = b._preloadHash[c].length; e > d; d++) {
            var f = b._preloadHash[c][d];
            if (
              ((b._preloadHash[c][d] = !1), b.hasEventListener("fileerror"))
            ) {
      ...
      (b._registerSound = function (c) {
        ...
        var d;
        if (
          (c.src instanceof Object
            ? ((d = b._parseSrc(c.src)), (d.src = c.path + d.src))
            : (d = b._parsePath(c.src)),
          null == d)
        )
          return !1;
        ...
        return (
          a.create(c.src, f),
          null != e && isNaN(e)
            ? (c.data.channels = f || a.maxPerChannel())
            : (c.data = f || a.maxPerChannel()),
          i.type && (c.type = i.type),
          c.defaultPlayProps &&
            (b._defaultPlayPropsHash[c.src] = createjs.PlayPropsConfig.create(
              c.defaultPlayProps,
            )),
          i
        );
      ...
      (b.removeSound = function (c, d) {
        ...
        if (
          (c instanceof Object
            ? (e = b._parseSrc(c))
            : ((c = b._getSrcById(c).src), (e = b._parsePath(c))),
          null == e)
        )
          return !1;
      ...
      (b._parsePath = function (a) {
        ...
        for (var d = c[4], e = c[5], f = b.capabilities, g = 0; !f[e]; )
          if (
            ((e = b.alternateExtensions[g++]), g > b.alternateExtensions.length)
          )
            return null;
        a = a.replace("." + c[5], "." + e);
      ...
      (b.setDefaultPlayProps = function (a, c) {
        ((a = b._getSrcById(a)),
          (b._defaultPlayPropsHash[b._parsePath(a.src).src] =
            createjs.PlayPropsConfig.create(c)));
      }),
      ...
      (b._playInstance = function (a, c) {
        ...
        if (
          (null == c.interrupt &&
            (c.interrupt = d.interrupt || b.defaultInterruptBehavior),
          null == c.delay && (c.delay = d.delay || 0),
          null == c.offset && (c.offset = a.position),
    ...
    ((c.constructor = a),
      ...
      (c._getSlot = function (a) {
        var b, c;
        if (a != Sound.INTERRUPT_NONE && ((c = this._get(0)), null == c))
          return !0;
    ...
    ((b.context = null),
      ...
      (a._handleSoundReady = function () {
        ...
        var a = 0.001 * this._duration,
          c = Math.min(0.001 * Math.max(0, this._position), a);
        ((this.sourceNode = this._createAndPlayAudioNode(
          b.context.currentTime - a,
          c,
        )),
      ...
      (a._pause = function () {
        ((this._position =
          1e3 * (b.context.currentTime - this._playbackStartTime)),
          (this.sourceNode = this._cleanUpAudioNode(this.sourceNode)),
          (this._sourceNodeNext = this._cleanUpAudioNode(this._sourceNodeNext)),
          0 != this.gainNode.numberOfOutputs && this.gainNode.disconnect(0),
          clearTimeout(this._soundCompleteTimeout));
    ...
    ((b._capabilities = null),
      ...
      (b._generateCapabilities = function () {
        if (null == b._capabilities) {
          ...
          if (
            null == b.context &&
            ((b.context = b._createAudioContext()), null == b.context)
          )
            return null;
          (null == b._scratchBuffer &&
            (b._scratchBuffer = b.context.createBuffer(1, 1, 22050)),
            b._compatibilitySetUp(),
            "ontouchstart" in window &&
              "running" != b.context.state &&
              (b._unlock(),
      ...
      (b._createAudioContext = function () {
        ...
        if (
          ...
          c.sampleRate !== b.DEFAULT_SAMPLE_RATE
        ) {
      ...
      (createjs.WebAudioPlugin = createjs.promote(
        WebAudioPlugin,
        "AbstractPlugin",
      )));
  })(),
  ...
  (function () {
    ...
    ((b._tags = {}),
      ...
      (b.remove = function (a) {
        ...
        return null == c
          ? !1
          : (b._tagPool.set(c), delete b._tags[a], delete b._tagUsed[a], !0);
      }),
